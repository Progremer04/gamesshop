...
if (isset($_POST["submit"])) {
    ...
    $price = $_POST["price"];
    $platform = "pc"; // Platform selection from the form
    ...
    if (move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . $upload_dir . $file_name)) {
        ...
        $sql = "INSERT INTO digital_codes (title, description, price, image_url, platform) VALUES ('$title', '$description', '$price', '$image_url', '$platform')";
    ...
    <div class="wrapper">
        <div class="form-wrapper sign-in">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" name="submit" onclick="return confirm('Are you sure you want to Add This Digital Codes?')">Add Digital Codes</button>
            </form>
        </div>
