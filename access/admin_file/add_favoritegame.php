...
if (isset($_POST["submit"])) {
    ...
    if (move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . $upload_dir . $file_name)) {
        ...
        $sql = "INSERT INTO favorite_game (title, description, price, image_url, platform) VALUES ('$title', '$description', '$price', '$image_url', '$platform')";
    ...
    <div class="wrapper">
        <div class="form-wrapper sign-in">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" name="submit" onclick="return confirm('Are you sure you want to Add This Favorite Game?')">Add Favorite Game</button>
            </form>
        </div>
