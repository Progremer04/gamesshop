...
if (isset($_POST["submit"])) {
    ...
    if (move_uploaded_file($file_tmp, $_SERVER['DOCUMENT_ROOT'] . $upload_dir . $file_name)) {
        ...
        $sql = "INSERT INTO gift_card (title, description, price, image_url) VALUES ('$title', '$description', '$price', '$image_url')";
    ...
    <div class="wrapper">
        <div class="form-wrapper sign-in">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" name="submit" onclick="return confirm('Are you sure you want to Add This Gift Card?')">Add Gift Card</button>
            </form>
        </div>
